...
@section('content')
    <div class="page-content container-fluid" x-data="product_collections">
        <form role="form"
            class="form-edit-add"
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel ">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                {{ trans('product-collections.Name') }}
                            </h3>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                {{ trans('product-collections.Description') }}
                            </h3>
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="panel ">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                {{ trans('product-collections.Products') }}
                            </h3>
                        </div>
                        <div class="panel-body">
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel">
                        <div class="panel-heading-botom">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ trans('product-collections.Status') }}</h3>
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="panel ">
                        <div class="panel-heading-botom">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ trans('product-collections.Is featured?') }}</h3>
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
                    ...
                    <div class="panel">
                        <div class="panel-heading-botom">
                            <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ trans('product-collections.Image') }}</h3>
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
            ...
            @section('submit-buttons')
                <button type="submit" class="btn btn-primary pull-right">
                     @if($edit){{ trans('product-collections.Update collections') }}@else <i class="icon wb-plus-circle"></i> {{ trans('product-collections.Create new collections') }}@endif
                </button>
            @stop
...
@section('javascript')
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('product_collections', () => ({
