...
@section('content')
    <div class="page-content container-fluid" x-data="product_tags">
        <form role="form"
            class="form-edit-add"
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel ">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                {{ trans('product-tags.Description') }}
                            </h3>
                        </div>
                        <div class="panel-body">
            ...
            @section('submit-buttons')
                <button type="submit" class="btn btn-primary pull-right">
                     @if($edit){{ trans('product-tags.Update tags') }}@else <i class="icon wb-plus-circle"></i> {{ trans('product-tags.Create new tags') }}@endif
                </button>
            @stop
